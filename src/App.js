    ...
    <div>
      <div className="flex flex-col lg:mx-8 lg:flex-row">
        <div className="w-full mt-8 lg:mt-0">
          ...
          <p className="text-gray-600 leading-loose mb-6">
            We at design at decks would like to offer you free estimate, quote or maybe just an inquiry about your plans and we are happy to help.
            Just message us below in this simply website because we don't want to over complicate things for our future clients and hopefully that is you.
          </p>
          <p className="text-gray-600 leading-loose mb-6">
            Thank you
          </p>
...
<div className="bg-[url('./images/exteriorday.jpg')] bg-center bg-cover relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal8" type="button">
    <h2
      className="absolute uppercase pl-4 lg:pl-10 pb-2 lg:pb-8 bottom-0 font-medium text-lg lg:text-xl text-gray-100 z-20">
     Day</h2>
</div>
...
<div className="bg-[url('./images/indoor1.jpg')] bg-center bg-cover hover:opacity-60 cursor-pointer relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal" type="button">
</div>
...
<div className="bg-[url('./images/indoor2.jpg')] bg-center bg-cover hover:opacity-60 cursor-pointer relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal1" type="button" >
</div>
...
<div className="bg-[url('./images/indoor3.jpg')] bg-center bg-cover hover:opacity-60 cursor-pointer relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal2" type="button" >
</div>
...
<div className="bg-[url('./images/indoor4.jpg')] bg-center bg-cover  hover:opacity-60 cursor-pointer relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal3" type="button">
</div>
...
<div className="bg-[url('./images/outdoor1.jpg')] bg-center bg-cover hover:opacity-60 cursor-pointer relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal4" type="button">
</div>
...
<div className="bg-[url('./images/outdoor2.jpg')] bg-center bg-cover hover:opacity-60 cursor-pointer relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal5" type="button">
</div>
...
<div className="bg-[url('./images/outdoor3.jpg')] bg-center bg-cover hover:opacity-60 cursor-pointer relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal6" type="button">
</div>
...
<div className="bg-[url('./images/outdoor4.jpg')] bg-center bg-cover hover:opacity-60 cursor-pointer relative h-60 flex-grow-1 w-full" data-modal-toggle="defaultModal7" type="button">
</div>
...
<div className='flex-col justify-center mb-20'>
        ...
        <h1 className='mt-0 p-6 text-2xl text-theme'>Free Estimate & Quote</h1>
        </div>
